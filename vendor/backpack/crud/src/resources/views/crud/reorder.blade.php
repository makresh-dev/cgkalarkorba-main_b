...
<link rel="stylesheet" href="{{ asset('public/packages/backpack/crud/css/reorder.css') }}">
@endsection

@section('after_scripts')
<script src="{{ asset('public/packages/backpack/crud/js/crud.js') }}" type="text/javascript" ></script>
<script src="{{ asset('public/packages/backpack/crud/js/reorder.js') }}" type="text/javascript" ></script>
