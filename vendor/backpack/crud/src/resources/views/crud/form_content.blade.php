...
@section('after_styles')
    <link rel="stylesheet" href="{{ asset('public/packages/backpack/crud/css/crud.css') }}">
    <link rel="stylesheet" href="{{ asset('public/packages/backpack/crud/css/form.css') }}">
    <link rel="stylesheet" href="{{ asset('public/packages/backpack/crud/css/'.$action.'.css') }}">
...
@section('after_scripts')
    <script src="{{ asset('public/packages/backpack/crud/js/crud.js') }}"></script>
    <script src="{{ asset('public/packages/backpack/crud/js/form.js') }}"></script>
    <script src="{{ asset('public/packages/backpack/crud/js/'.$action.'.js') }}"></script>
